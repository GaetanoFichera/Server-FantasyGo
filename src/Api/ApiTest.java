...
public class ApiTest {
    ...
    public void SaveZoneDiCaccia() {
        ...
        try {
            ...
            Coordinata coordinata811 = new Coordinata(13.3528519, 42.3077842);
            coordinateConfini8.add(coordinata811);
            ...
            Coordinata coordinata91 = new Coordinata(13.4256363, 42.3258086);
            coordinateConfini9.add(coordinata91);
            Coordinata coordinata92 = new Coordinata(13.4836578, 42.3242856);
            coordinateConfini9.add(coordinata92);
            Coordinata coordinata93 = new Coordinata(13.4884644, 42.3133698);
            coordinateConfini9.add(coordinata93);
            Coordinata coordinata94 = new Coordinata(13.5358429, 42.3311388);
            coordinateConfini9.add(coordinata94);
            Coordinata coordinata95 = new Coordinata(13.5821915, 42.3798508);
            coordinateConfini9.add(coordinata95);
            Coordinata coordinata96 = new Coordinata(13.6244202, 42.4046996);
            coordinateConfini9.add(coordinata96);
            Coordinata coordinata97 = new Coordinata(13.6453629, 42.4059672);
            coordinateConfini9.add(coordinata97);
            Coordinata coordinata98 = new Coordinata(13.6659622, 42.4401809);
            coordinateConfini9.add(coordinata98);
            Coordinata coordinata99 = new Coordinata(13.6261368, 42.4644993);
            coordinateConfini9.add(coordinata99);
            Coordinata coordinata910 = new Coordinata(13.5543823, 42.4609535);
            coordinateConfini9.add(coordinata910);
            Coordinata coordinata911 = new Coordinata(13.5042572, 42.4908336);
            coordinateConfini9.add(coordinata911);
            Coordinata coordinata912 = new Coordinata(13.4486389, 42.5290493);
            coordinateConfini9.add(coordinata912);
            Coordinata coordinata913 = new Coordinata(13.4105301, 42.536639);
            coordinateConfini9.add(coordinata913);
            Coordinata coordinata914 = new Coordinata(13.3779144, 42.5209526);
            coordinateConfini9.add(coordinata914);
            Coordinata coordinata915 = new Coordinata(13.3325958, 42.5001999);
            coordinateConfini9.add(coordinata915);
            Coordinata coordinata916 = new Coordinata(13.326416, 42.4746292);
            coordinateConfini9.add(coordinata916);
            Coordinata coordinata917 = new Coordinata(13.3820343, 42.4627264);
            coordinateConfini9.add(coordinata917);
            Coordinata coordinata918 = new Coordinata(13.3975241, 42.4650344);
            coordinateConfini9.add(coordinata918);
            Coordinata coordinata919 = new Coordinata(13.4527588, 42.4168669);
            coordinateConfini9.add(coordinata919);
            Coordinata coordinata920 = new Coordinata(13.4527588, 42.3676763);
            coordinateConfini9.add(coordinata920);
            Coordinata coordinata921 = new Coordinata(13.4256363, 42.3258086);
            coordinateConfini9.add(coordinata921);
    ...
    public String prova() {
        ...
        Personaggio Gaetano = new Personaggio("P0001", "Gaetano", caratteristicheA, equipaggiamento, 0, "M", "Umano", "Tizio", 0, inv, 0);
        Giocatore g1 = new Giocatore("G00001", "Gaet", "nonlaso", null);
        g1.addPersonaggio(Gaetano);
        Gaetano.setGiocatore(g1);
        System.out.println(Gaetano.toString());
        Session session = null;
        Transaction transaction = null;
        try {
            session = HibernateUtil.getSession();
