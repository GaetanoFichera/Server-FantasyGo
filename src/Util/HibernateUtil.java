...
public class HibernateUtil {
    ...
    public static ZonaDiCaccia retrieveZonaDiCaccia(String idZonaDiCaccia, Session session){
        ZonaDiCaccia zonaDiCaccia = session.find(ZonaDiCaccia.class, idZonaDiCaccia);

        return zonaDiCaccia;
    }

    public static Personaggio retrievePersonaggio(String idPersonaggio, Session session){
        Personaggio personaggio = session.find(Personaggio.class, idPersonaggio);

        return personaggio;
    }

    public static Mostro retrieveMostro(String idMostro, Session session){
        Mostro mostro = session.find(Mostro.class, idMostro);
